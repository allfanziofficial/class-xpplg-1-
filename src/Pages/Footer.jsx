					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/allflq_/?hl=id" class="hover:underline">
										allflq_
									</a>
								</li>
								<li>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								...
								<li>
									<a href="https://www.youtube.com/@10RPL1" class="hover:underline">
										Youtube
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas X PPLG 1 | Di Kelola Oleh Siswa PPLG 1
						</p>
					</div>
				</div>
			</div>
